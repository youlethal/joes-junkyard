...
export default function Hero() {
  const heroTitle = "Welcome to Joes Junkyard";
  const heroSubtitle = "Professional Services";
  const heroDescription = "We deliver exceptional quality and outstanding results for all your needs. Our experienced team is dedicated to providing the best service possible.";
  const ctaPrimary = "Our Services";
  const ctaSecondary = "Get Quote";
  const heroIcon = "🏢";
  const heroStats = [{"value":"5.0","label":"Customer Rating"},{"value":"100+","label":"Happy Clients"},{"value":"10+","label":"Years Experience"}];
  const heroFeatures = ["Professional Service","Quality Work","Expert Team"];
