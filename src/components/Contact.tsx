...
export default function Contact() {
  const businessName = "Joes Junkyard";
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      content: 'info@joes junkyard.com',
      action: 'Send Email',
      actionLink: 'mailto:info@joes junkyard.com'
    },
    {
      icon: Clock,
    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-4">Contact Us Today</p>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Ready to get started? Contact us for a consultation or quote. Our team is here to help you with all your needs.</p>
        </motion.div>
